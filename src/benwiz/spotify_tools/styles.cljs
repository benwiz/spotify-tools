(ns benwiz.spotify-tools.styles
  (:require-macros
...
(defglobal defaults
  [:body
   {#_#_:color                   :red
    :background-color        #_:#e0e0e0 :#F8F9F9
    ...
    #_#_:background-size     [[(px 100) (px 100)] [(px 100) (px 100)] [(px 20) (px 20)] [(px 20) (px 20)]]
    #_#_:background-position [[(px -2) (px -2)] [(px -2) (px -2)] [(px -1) (px -1)] [(px -1) (px -1)]]}])
